...
function IncidentCard({ attackType, severity, sourceIP, target, timestamp, status, id, onViewDetails, onMarkResolved }) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <button
          ...
          className="w-full sm:flex-1 flex items-center justify-center gap-1.5 rounded-lg border border-gray-300 bg-white py-1.5 sm:py-2 px-3 text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-150"
        >
          View Details
        ...
        <button
          ...
          className="w-full sm:flex-1 flex items-center justify-center gap-1.5 rounded-lg border border-green-200 bg-green-50 py-1.5 sm:py-2 px-3 text-xs sm:text-sm font-medium text-green-700 hover:bg-green-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-150"
        >
          Mark Resolved
          <CheckCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4" strokeWidth={2} />
        </button>
      </div>
    </div>
  );
